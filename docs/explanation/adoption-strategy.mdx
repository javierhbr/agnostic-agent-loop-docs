---
title: "Two-Iteration Adoption Strategy"
slug: /explanation/adoption-strategy
sidebar_label: Adoption Strategy
description: How teams adopt the unified SDD methodology in two iterations with an evaluation gate between them.
---
