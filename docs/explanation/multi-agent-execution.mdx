...
slug: /explanation/multi-agent-execution
sidebar_label: Multi-Agent Execution
description: How the agentic-agent CLI supports executing tasks with multiple AI agents including Claude, Copilot, Gemini, and more.
---
...
- Limited to command-line suggestions
...
- Requires manual execution in Cursor IDE
...
# Output:
# Agent execution error: API rate limit exceeded
...
- [Autopilot vs Ralph Loop](/explanation/autopilot-vs-ralph)
- [Plugin System](/explanation/plugin-system)
