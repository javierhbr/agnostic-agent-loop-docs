---
title: "Plugin System"
slug: /explanation/plugin-system
sidebar_label: Plugin System
description: How the agnostic-agent CLI plugin system extends functionality with skill packs, validators, commands, and hooks.
---
