---
title: "Platform vs Component Boundary"
slug: /explanation/platform-component-boundary
sidebar_label: Platform vs Component
description: The hard boundary between platform-level and component-level work in SDD, and why it matters.
---
