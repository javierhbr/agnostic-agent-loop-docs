---
id: examples-sdd-risk
title:  Risk Assessment (Phase 2)
slug: /agentic-agent-cli/examples/sdd/risk
description: Classify risk and select the SDD workflow (Full) for Subscription Billing.
---
...
<SectionHeader
  num="15x"
  title=" Risk Assessment (Phase 2)"
  desc="Classify risk and select the SDD workflow (Full) for Subscription Billing."
/>
...
<details>
  <summary>02-risk-assessment/risk-classification.md</summary>
