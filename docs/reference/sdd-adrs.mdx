---
title: "SDD Methodology ADR Index"
slug: /reference/sdd-adrs
sidebar_label: ADR Index
description: Reference summary of all 14 Architecture Decision Records from the unified SDD methodology.
---
