---
title: "The 3-Tier Layered Context Model"
slug: /reference/layered-context-model
sidebar_label: Layered Context Model
description: Architecture for organizing agent guidance that minimizes context bloat while maximizing precision.
---
