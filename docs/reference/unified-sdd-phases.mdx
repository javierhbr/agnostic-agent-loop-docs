---
title: "Unified SDD Methodology: 5-Phase Reference"
slug: /reference/unified-sdd-phases
sidebar_label: SDD Phases
description: Reference document for the five-phase Spec-Driven Development lifecycle with entry/exit criteria and artifact outputs.
---
