---
title: "Worktree & PR Architecture Diagram"
slug: /reference/worktree-pr-architecture
sidebar_label: Worktree Architecture
description: System architecture diagrams for worktree-based task workflow and PR management.
---
...
agentic-agent pr review --task TASK-123 --pr-url https://github.com/.../42
    ...
    │  3. agentic-agent specify gate-check <spec>    │
