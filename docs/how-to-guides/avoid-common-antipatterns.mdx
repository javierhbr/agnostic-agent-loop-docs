---
title: "How to Avoid Common Anti-Patterns"
slug: /how-to-guides/avoid-common-antipatterns
sidebar_label: Avoid Anti-Patterns
description: Identify and avoid the most common pitfalls when working with the Agentic Agent CLI and SDD workflow.
---
