---
title: "SDD Example Workflow: Validated Customer Email Updates"
slug: /tutorials/sdd-example-workflow
sidebar_label: SDD Example Workflow
description: Walk through a complete SDD workflow using the unified 5-phase methodology with a real-world customer email update example.
---
