---
title: "Worktree & PR Workflow"
slug: /tutorials/worktree-pr-workflow
sidebar_label: Worktree & PR Workflow
description: Quick-start guide for the claim-develop-PR-review-complete workflow using git worktrees.
---
...
### 1. Claim Task (Auto-Creates Worktree)
...
### 3. Create PR (Auto-Generate from Spec)
...
### 4. Spawn Reviewer (Independent Review)
...
- **[Worktree & PR Implementation](/reference/worktree-pr-implementation)** -- Complete reference
- **[Worktree & PR Architecture](/reference/worktree-pr-architecture)** -- System design & diagrams
- **[Worktree & PR Examples](/how-to-guides/worktree-pr-examples)** -- Real-world scenarios
